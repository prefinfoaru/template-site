                    ...
                    <div className="flex-grow-1">
                        <div className="h-100 d-md-flex align-items-center auth-side-img">
                            <div className="col-sm-10 auth-content w-auto">
                                ...
                                <h4 className="text-white font-weight-normal">Signin to your account and get explore the Next Dashboard Template.<br/>Do not forget to play with live customizer</h4>
                            </div>
                        </div>
