...
class Navigation extends Component {
    ...
    render() {
        ...
        if (this.props.layoutType === 'dark') {
            document.body.classList.add('next-dark');
        } else {
            document.body.classList.remove('next-dark');
        }

        if (this.props.rtlLayout) {
            document.body.classList.add('next-rtl');
        } else {
            document.body.classList.remove('next-rtl');
        }
