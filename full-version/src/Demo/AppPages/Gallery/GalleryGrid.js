                            ...
                            <Card.Body>
                                <Row>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb1, thumbnail: thumb1, caption:"Next Image 1", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb2, thumbnail: thumb2, caption:"Next Image 2", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb3, thumbnail: thumb3, caption:"Next Image 3", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb4, thumbnail: thumb4, caption:"Next Image 4", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb5, thumbnail: thumb5, caption:"Next Image 5", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                    <Col xl={4} md={6} className='mb-4'>
                                        <Gallery images={[{src: thumb6, thumbnail: thumb6, caption:"Next Image 6", useForDemo:true}]} backdropClosesModal singleItem />
                                    </Col>
                                </Row>
                            </Card.Body>
                        </Card>
